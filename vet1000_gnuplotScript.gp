...
set output 'imgs/algorithms1000_comparison.png'
...
plot \
    'datasets/Matrix_Dados/Ordenado_1000.txt' using 1 with linespoints ls 1 title 'Algoritmo 1 (Ordenado 1000)', \
    '' using 2 with linespoints ls 2 title 'Algoritmo 2 (Ordenado 1000)', \
    '' using 3 with linespoints ls 3 title 'Algoritmo 3 (Ordenado 1000)', \
    'datasets/Matrix_Dados/Desordenado_1000.txt' using 1 with linespoints ls 4 title 'Algoritmo 1 (Desordenado 1000)', \
    '' using 2 with linespoints ls 5 title 'Algoritmo 2 (Desordenado 1000)', \
    '' using 3 with linespoints ls 6 title 'Algoritmo 3 (Desordenado 1000)'
# Legenda
